...
class NodeEditorWindow(QMainWindow):
    ...
    def createFileMenu(self) -> None:
        ...
        self.fileMenu: QMenu = menubar.addMenu('&File')
    ...
    def createEditMenu(self) -> None:
        menubar: QMenuBar = self.menuBar()
        self.editMenu: QMenu = menubar.addMenu('&Edit')
    ...
    def onFileSave(self):
        ...
        if current_nodeeditor is not None:
            ...
            self.statusBar().showMessage("Successfully saved %s" %
                                         current_nodeeditor.filename, 5000)
    ...
    def onFileSaveAs(self) -> bool:
        ...
        if current_nodeeditor is not None:
            fname, filter = QFileDialog.getSaveFileName(
                self, 'Save design to file', self.getFileDialogDirectory(), self.getFileDialogFilter())
            if fname == '':
                return False
